...
},{"./bundle-url":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"css/work.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/work.js":[function(require,module,exports) {
"use strict";
...
var prevButton = document.querySelector('.buttons > a:first-child');
var nextButton = document.querySelector('.buttons > a:nth-child(2)');
var body = document.querySelector('.sample-body');
var position = 0;
var info = false;
...
function updateSample() {
  ...
  var currentSample = samples[position];
  var header = document.querySelector('.sample-header');
  var newBody = '';

  if (info) {
    newBody = "<p>".concat(currentSample.body, "</p>");
  } else {
    newBody = "<p>".concat(currentSample.title, "</p>");
  }

  header.innerHTML = "<h2>".concat(currentSample.title, "</h2>");
...
},{"../css/work.scss":"css/work.scss"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/work.js"], null)
